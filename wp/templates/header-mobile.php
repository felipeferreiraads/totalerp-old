    ...
    <div class="container">
        ...
        <nav class="tw-bg-blue-darker tw-mt-4 tw--mx-4 tw-p-4 menu-mobile">
            ...
            <div class="tw-flex tw-items-center">
                <a href="" class="tw-bg-header tw-text-12 tw-flex tw-items-center tw-px-4 tw-py-3 tw-rounded-tl-full  tw-rounded-bl-full ">
                    <i class="fa tw-text-white tw-text-18 fa-shopping-cart"></i>
                    <span class="tw-text-white tw-ml-2">MEUS PEDIDOS</span>
                </a>
